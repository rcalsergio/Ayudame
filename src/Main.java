...
public class Main {
    ...
    public static double promedioAltitudes(double[] altitudesKm) {
        double sumaTotalAltidudes = 0;

        // recorremos y sumamos cada altitud del array en una variable
        for (int i = 0; i < altitudesKm.length; i++) {
            sumaTotalAltidudes += altitudesKm[i];
        }

        // retornamos la suma total de las altitudes dividida por la cantidad
        // de altitudes para obtener el promedio
        return sumaTotalAltidudes / altitudesKm.length;
    }
